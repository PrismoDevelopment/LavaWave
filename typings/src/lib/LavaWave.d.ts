...
import type { IncomingDiscordPayload, LavaWaveEvents, LavaWaveOptions, OutgoingDiscordPayload, PlayerOptions, SEARCH_SOURCE, SearchResult } from '../@types';
export default class LavaWave extends EventEmitter {
    ...
    static checkOptions(options: LavaWaveOptions): void;
    /**
    ...
    emit<EventName extends keyof LavaWaveEvents>(event: EventName, ...args: Parameters<LavaWaveEvents[EventName]>): boolean;
    on<EventName extends keyof LavaWaveEvents>(event: EventName, listener: LavaWaveEvents[EventName]): this;
    once<EventName extends keyof LavaWaveEvents>(event: EventName, listener: LavaWaveEvents[EventName]): this;
    /**
